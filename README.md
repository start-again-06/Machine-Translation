...
A comprehensive NLP project that implements a sequence-to-sequence (seq2seq) model with attention to convert human-readable dates (e.g., "21th of August 2016") into machine-readable formats (e.g., "2016-08-21"). Built using TensorFlow/Keras, it demonstrates a practical application of Neural Machine Translation (NMT) techniques.

## Dataset
- Size: 10,000 generated examples  
...
- Attention Layer: Custom mechanism aligning decoder state with encoder outputs  
...
## Usage
- Translate a date: `translate_date("4th of July 2001")`  
- Visualize attention: `plot_attention_map(...)` to inspect attention weights
...
- Trained end-to-end with attention from scratch or using pretrained weights  
- Extensible to other character-level NMT tasks
